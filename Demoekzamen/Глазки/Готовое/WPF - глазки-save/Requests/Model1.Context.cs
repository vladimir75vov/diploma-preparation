...
namespace WPF___глазки_save.Requests
{
    using System;
    ...
    public partial class testglazkiavtorEntities : DbContext
    {
        public testglazkiavtorEntities()
            : base("name=testglazkiavtorEntities")
        {
        }
